...
var creatorList = ['@zahirrr','@zhirrrgans','@zhirr_ajalah','@zahiranjay', '@prassetiyonossss','@zhirrganteng','@zahirrgantengg'];
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'prassetiyonos') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'prassetiyonos') return res.json(loghandler.invalidKey)
