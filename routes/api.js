...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------PRAZ'+'KEDIRI';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'praz') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'praz') return res.json(loghandler.invalidKey)
